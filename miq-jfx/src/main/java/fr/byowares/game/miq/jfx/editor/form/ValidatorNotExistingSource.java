...
/**
 * A validator that ensure a source does not exist.
 *
 * @since XXX
 */
public class ValidatorNotExistingSource
        implements FormFieldValidator<String> {

    /** Singleton pattern. */
    public static final ValidatorNotExistingSource INSTANCE = new ValidatorNotExistingSource();

    private ValidatorNotExistingSource() {
        // Singleton pattern
    }
