...
public abstract class VersionedDeserializer<T> {
    ...
    protected static char removeAsCharacter(
        ...
        final String v = Objects.requireNonNull(removeAsString(map, key));
    ...
    protected static String removeAsString(
        ...
        return remove(map, key, String.class, null);
    }
     ...
     */
    protected abstract T doDeserialize(final Map<String, Object> map);
