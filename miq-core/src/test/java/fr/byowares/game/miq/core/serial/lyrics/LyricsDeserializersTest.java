...
import static fr.byowares.game.miq.core.serial.lyrics.LyricsDeserializerV1Test.INPUT_V1;
import static fr.byowares.game.miq.core.serial.lyrics.LyricsDeserializerV1Test.LYRICS_V1;
import static fr.byowares.game.miq.core.serial.lyrics.LyricsDeserializerV1Test.VERSION_V1;
...
public class LyricsDeserializersTest
        extends AbstractDeserializersTest<Lyrics> {

    @Override
    protected Lyrics getObjectT() {
        return LYRICS_V1;
    }
